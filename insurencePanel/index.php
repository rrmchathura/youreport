  ...
  <form class="modal-content animate" action="../API/updateAccidentForInsurance.php" method="POST" style="width:95%;">
    ...
    <tr>
      ...
      <select name="approvel" style=" width: 150px;">
        <option value="NOT_APPROVED">Solved</option>
        <option value="APPROVED">Not Solved</option>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLhBU04o3cx1Yo0auCEBCTiLEYu_KWCl4&callback=myMap"></script>
